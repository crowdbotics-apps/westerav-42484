"""
Django settings for westerav_42484 project.
...
ROOT_URLCONF = 'westerav_42484.urls'
...
WSGI_APPLICATION = 'westerav_42484.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "westerav_42484 API",
    "DESCRIPTION": "API documentation for westerav_42484 App",
    "VERSION": "v1",
}
